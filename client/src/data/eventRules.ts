...
export const eventRules: Record<string, EventRules> = {
  "efootball": {
    rules: [
      ...
      "Prior to every match, each player must share a screenshot of their selected team in the organizers' designated group.",
      "Upon match completion, both players are required to submit a screenshot of the final result — failure to do so may result in the match being declared void.",
      "All rounds will follow a knockout (elimination) format; the losing player will be immediately eliminated from the tournament.",
      ...
      "Use of emulators or any third-party software to gain an advantage is strictly prohibited.",
      ...
      "Any offensive behavior, abusive language, or threatening conduct will result in immediate disqualification.",
      "In the event of a technical interruption (such as network issues), the affected player must provide supporting evidence and, upon verification, the match will be restarted under the same conditions.",
    ],
  },
  "chess": {
    rules: [
      ...
      "Participants of all rating levels are welcome; no prior chess rating is required for registration.",
      ...
      "Offensive or unsportsmanlike behavior during or outside the platform will lead to immediate removal from the tournament.",
      "All participants must join the official Lichess tournament on time; late arrivals may negatively impact their standing.",
      "The top two players with the highest cumulative points at the conclusion of the tournament will be declared the winners.",
      "All participants must join the official Technobit'26 Chess team on Lichess before the event begins.",
    ],
    groupLink: {
  ...
  "pubg-mobile": {
    rules: [
      ...
      "A team may consist of a minimum of 1 (solo) and a maximum of 4 main players; all members must be enrolled students from the same college.",
      "An optional 5th player may be registered as a substitute; the substitute may only play if a main team member is unable to participate.",
      ...
      "Teams that fail to be present for their scheduled match within the allotted grace period risk forfeiture of the match.",
  ...
  "free-fire": {
    rules: [
      "This is a team-based event; the specific game mode will be officially announced by the organizers prior to the commencement of the tournament.",
      "A team may consist of a minimum of 1 (solo) and a maximum of 4 main players; all members must be from the same college.",
      ...
      "Participants are expected to maintain sportsmanship and conduct themselves respectfully throughout the duration of the tournament.",
      "The organizers' decisions are final in all disputes and matters concerning the event.",
    ],
  },
  "it-olympiad": {
    rules: [
      "Each participant will be provided with 30 multiple-choice questions covering a wide range of Information Technology topics including hardware, software, networking, cybersecurity, and general computing concepts.",
      "Participants will be allotted a total duration of 20 minutes to complete all assigned questions.",
      "This is a strictly individual event; any form of collaboration, discussion, or use of external resources is considered a violation and will lead to immediate disqualification.",
      "Participants are prohibited from using AI tools, search engines, or any electronic assistance during the competition.",
      ...
      "Only currently enrolled students of Bir Nirmal Mohammad Public College (BNMPC) are eligible to participate.",
  ...
  "gaming-quiz": {
    rules: [
      ...
      "Participants will be allotted a duration of 20 minutes to answer all questions in the first round.",
      "In the event of a tie among top contestants, a tiebreaker round of 10 minutes will be conducted to determine the final rankings.",
      ...
      "Only currently enrolled BNMPC students are eligible to participate.",
    ],
  },
  "robothon-olympiad": {
    rules: [
      "Each participant will be assessed through 30 multiple-choice questions encompassing both Robotics and Cybersecurity topics.",
      "Participants are required to complete all questions within the allocated time without referencing any books, notes, or mobile devices.",
      "This is a strictly individual event; collaboration or communication with any other participant is prohibited.",
      "Prior registration through the official Technobit event portal is mandatory before the deadline; no late registrations will be accommodated.",
  ...
  "marvel-dc-quiz": {
    rules: [
      "Each participant will be challenged with 30 multiple-choice questions spanning the Marvel and DC universes — covering characters, storylines, cinematic events, and comic lore.",
      "Participants will be given a duration of 20 minutes to complete the first round.",
      "In the event of a tie among leading participants, a dedicated tiebreaker round of 10 minutes will determine the final standings.",
    ...
    topics: [
      "Spider-Man", "Iron Man", "Captain America", "Batman", "Superman", "Wonder Woman", "Avengers", "Justice League", "Marvel Cinematic Universe", "DC Extended Universe"
    ],
  },
  "animelogia": {
    rules: [
      "The event will be conducted in a single round, with a separate tiebreaker round administered if required.",
      "Each participant will be provided with 30 questions covering a broad spectrum of anime knowledge within a time limit of 20 minutes.",
      "In the event of a tie among leading participants, a tiebreaker round of 10 minutes will be administered to determine final rankings.",
    ...
    topics: [
      "Attack On Titan", "Demon Slayer", "Chainsaw Man", "Spy x Family", "Jujutsu Kaisen", "One Piece", "Naruto", "My Hero Academia", "Bleach", "Dragon Ball"
    ],
  },
  "google-it": {
    rules: [
      "This is an individual speed-research competition where participants must locate correct answers using Google Search as efficiently and accurately as possible.",
  ...
  "crack-the-code": {
    rules: [
      "The contest will be hosted on HackerRank, and all registered participants must join the official contest link provided by the organizers before the event begins.",
      ...
      "All solutions must be entirely original — collaboration, sharing code, discussing approaches, or use of unauthorized external resources is strictly prohibited.",
  ...
  "sci-fi-story": {
    rules: [
      "Participants must write an original science fiction story centered around futuristic themes such as artificial intelligence, space exploration, time travel, quantum science, or dystopian societies.",
      "AI-generated stories, plagiarized content, or previously published work will not be accepted and will result in immediate disqualification.",
    ...
    submissionInfo: [
      "Submit your work as a PDF or DOCX document through the official Technobit website or the designated submission portal.",
      "Ensure your submission file is properly named with your full name, section, and roll number.",
      "Late submissions will not be accepted under any circumstances — plan your time accordingly.",
    ],
  },
  "tech-meme-war": {
    rules: [
      "Each participant is allowed to submit only one original meme for the competition; multiple entries will result in disqualification.",
      "The submitted meme must be technology-related and created entirely by the participant.",
      "Content that involves bullying, hate speech, offensive language, political commentary, religious references, or targeted personal attacks is strictly prohibited and will result in immediate disqualification.",
  ...
  "ai-art": {
    rules: [
      "The submitted artwork must be generated using any AI-based tool of the participant's choice; manually created or hand-crafted artwork is not accepted.",
      "No specific theme restriction applies — participants are free to select any subject matter for their AI-generated artwork.",
      "Artwork containing offensive, plagiarized, or inappropriate content will be disqualified.",
      "The AI-generated image must be primarily produced by the participant's own prompting and creative direction.",
      "Only currently enrolled BNMPC students are eligible to participate.",
    ],
    submissionInfo: [
